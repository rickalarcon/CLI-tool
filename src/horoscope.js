/*
We will be exportion "getHoroscope" . We can also export that by doing
 mode.export = getHoroscope (at the bottom)

*/

const chalk = require("chalk"); //to add colors
const request = require('request'); //to sent HTTPre requests
